...
values
  ((select id from branches where slug = 'yeoksam-arc'),
   'P-OOH', 'OOH', '협의완료', '강남역 2번 출구 버스쉘터', '가로 2m × 세로 1m', '이미지',
   '2026-05-01', '2026-05-31', null, null, false, '{}', true),
  ((select id from branches where slug = 'yeoksam-arc'),
   'P-OOH', '현수막', '게시중', '건물 외벽 대형 현수막', '가로 5m × 세로 1.5m', '이미지',
   '2026-04-01', '2026-04-30', 180000, null, false, '{}', false),
  ((select id from branches where slug = 'yeoksam-arc'),
   'A-OOH', '바터제휴배너', '게시중', '옆 블록 카페 창측 배너', 'A2', '이미지',
   '2026-04-10', '2026-05-10', 0, '카페 원두 PT 수업 1회 제공', false, '{}', false),
  ((select id from branches where slug = 'yeoksam-arc'),
   'D-OOH', '전단지', '게시종료', '역삼역 인근 오피스 배포', 'A5', '이미지',
...
values
  ((select id from branches where slug = 'dogok'),
   'P-OOH', 'OOH', '협의중', '도곡역 스크린도어 광고 협의', null, '이미지',
   null, null, null, null, true, '{}', true),
  ((select id from branches where slug = 'dogok'),
   'P-OOH', '현수막', '게시중', '주민센터 앞 현수막 거치대', '가로 4m × 세로 0.9m', '이미지',
   '2026-04-01', '2026-04-30', 120000, null, false, '{}', false),
  ((select id from branches where slug = 'dogok'),
   'D-OOH', '족자', '아이디어', '도곡초 맞은편 카페 입구', null, null,
   null, null, null, null, false, '{}', false),
  ((select id from branches where slug = 'dogok'),
   'D-OOH', '전단지', '게시중', '타워팰리스 상가 라운지', 'A5', '이미지',
...
values
  ((select id from branches where slug = 'sindorim'),
   'P-OOH', 'OOH', '미진행', '신도림역 디스코 광고판 후보', null, null,
   null, null, null, null, false, '{}', true),
  ((select id from branches where slug = 'sindorim'),
   'P-OOH', '현수막', '게시중', '디큐브시티 외부 연결통로', '가로 3m × 세로 1m', '이미지',
   '2026-04-05', '2026-05-04', 150000, null, false, '{}', false),
  ((select id from branches where slug = 'sindorim'),
   'A-OOH', '바터제휴배너', '협의중', '이마트 신도림 입점사와 배너 교환 협의', 'B1', '이미지',
   null, null, null, '이마트 키즈카페 체험권 10매 제공', true, '{}', false),
  ((select id from branches where slug = 'sindorim'),
   'D-OOH', '족자', '게시종료', '역사 내 가판대', null, '이미지',
...
values
  ((select id from branches where slug = 'nonhyeon'),
   'P-OOH', 'OOH', '협의실패', '논현역 버스쉘터 공고 마감', null, null,
   null, null, null, null, false, '{}', true),
  ((select id from branches where slug = 'nonhyeon'),
   'P-OOH', '현수막', '게시중', '가구거리 중앙 현수막', '가로 4m × 세로 1m', '이미지',
   '2026-04-01', '2026-04-30', 160000, null, false, '{}', false),
  ((select id from branches where slug = 'nonhyeon'),
   'A-OOH', '바터제휴배너', '게시중', '필라테스 스튜디오 출입구 상호 배너', 'A2', '이미지',
   '2026-04-08', '2026-05-07', 0, '상호 회원 공동 이벤트 1회', false, '{}', false),
  ((select id from branches where slug = 'nonhyeon'),
   'D-OOH', '전단지', '협의완료', '영동시장 상인회 협의 완료', 'A4', '이미지',
...
values
  ((select id from branches where slug = 'pangyo'),
   'P-OOH', 'OOH', '협의완료', '판교역 지하 통로 대형 래핑', '가로 6m × 세로 2m', '이미지',
   '2026-05-01', '2026-07-31', null, null, true, '{}', true),
  ((select id from branches where slug = 'pangyo'),
   'P-OOH', '현수막', '게시중', 'H스퀘어 정문 현수막', '가로 4m × 세로 1.2m', '이미지',
   '2026-04-01', '2026-04-30', 200000, null, false, '{}', false),
  ((select id from branches where slug = 'pangyo'),
   'P-OOH', '족자', '게시중', '로비 엘리베이터 옆 족자', 'B2', '이미지',
   '2026-04-01', '2026-06-30', 80000, null, false, '{}', false),
  ((select id from branches where slug = 'pangyo'),
   'A-OOH', '바터제휴배너', '아이디어', '테크노밸리 카페 체인 제휴 아이디어', null, null,
...
values
  ((select id from branches where slug = 'gangbyeon'),
   'P-OOH', 'OOH', '미진행', '강변역 테크노마트 LED 후보', null, null,
   null, null, null, null, false, '{}', true),
  ((select id from branches where slug = 'gangbyeon'),
   'P-OOH', '현수막', '게시중', '테크노마트 외벽', '가로 5m × 세로 1m', '이미지',
   '2026-04-01', '2026-04-30', 170000, null, false, '{}', false),
  ((select id from branches where slug = 'gangbyeon'),
   'D-OOH', '전단지', '게시중', '구의공원 산책로', 'A5', '이미지',
   '2026-04-10', '2026-04-25', 50000, null, false, '{}', false),
  ((select id from branches where slug = 'gangbyeon'),
   'D-OOH', '기타', '아이디어', '한강공원 간이 스탠딩 보드', null, null,
...
values
  ((select id from branches where slug = 'gasan'),
   'P-OOH', 'OOH', '협의중', '가산디지털단지 시내버스 외부 래핑', null, null,
   null, null, null, null, false, '{}', true),
  ((select id from branches where slug = 'gasan'),
   'P-OOH', '현수막', '게시종료', '마리오아울렛 옆 공터', '가로 4m × 세로 1m', '이미지',
   '2026-03-01', '2026-03-31', 140000, null, false, '{}', false),
  ((select id from branches where slug = 'gasan'),
   'A-OOH', '바터제휴배너', '게시중', '가산 W몰 내 푸드코트 배너', 'A1', '이미지',
   '2026-04-05', '2026-05-04', 0, '푸드코트 주간 PT 체험권 5매', false, '{}', false),
  ((select id from branches where slug = 'gasan'),
   'D-OOH', '족자', '미진행', '지하철 2번 출구 인근 후보지', null, null,
   null, null, null, null, false, '{}', false);
...
values
  ((select id from branches where slug = 'samsung'),
   'P-OOH', 'OOH', '협의완료', '코엑스 지하 대형 LED 3월 집행 확정', null, '영상',
   '2026-05-15', '2026-06-15', null, null, false, '{}', true),
  ((select id from branches where slug = 'samsung'),
   'P-OOH', '현수막', '게시중', '본사 오피스 외벽', '가로 6m × 세로 1.5m', '이미지',
   '2026-04-01', '2026-04-30', 220000, null, false, '{}', false),
  ((select id from branches where slug = 'samsung'),
   'A-OOH', '바터제휴배너', '게시중', '삼성동 퍼스널 스튜디오 협업', 'A2', '이미지',
   '2026-04-12', '2026-05-11', 0, '원데이 클래스 상호 홍보', true, '{}', false),
  ((select id from branches where slug = 'samsung'),
   'D-OOH', '전단지', '아이디어', '코엑스몰 팝업 존 근처 배포 구상', null, null,
   null, null, null, null, false, '{}', false);
...
values
  ((select id from branches where slug = 'gwanghwamun'),
   'P-OOH', 'OOH', '협의중', '광화문역 스크린도어 협의', null, '이미지',
   null, null, null, null, false, '{}', true),
  ((select id from branches where slug = 'gwanghwamun'),
   'P-OOH', '현수막', '게시중', '광화문 오피스 건물 1층 로비', '가로 3m × 세로 1m', '이미지',
   '2026-04-01', '2026-04-30', 130000, null, false, '{}', false),
  ((select id from branches where slug = 'gwanghwamun'),
   'D-OOH', '족자', '게시중', '서점 체인 입구 족자 거치', 'B2', '이미지',
   '2026-04-08', '2026-05-07', 70000, null, false, '{}', false),
  ((select id from branches where slug = 'gwanghwamun'),
   'D-OOH', '전단지', '게시종료', '세종대로 오피스 배포', 'A5', '이미지',
...
values
  ((select id from branches where slug = 'hanti'),
   'P-OOH', 'OOH', '아이디어', '한티역 인근 디지털 사이니지 후보', null, null,
   null, null, null, null, true, '{}', true),
  ((select id from branches where slug = 'hanti'),
   'P-OOH', '현수막', '게시중', '대치동 학원가 입구', '가로 4m × 세로 1m', '이미지',
   '2026-04-01', '2026-04-30', 150000, null, false, '{}', false),
  ((select id from branches where slug = 'hanti'),
   'A-OOH', '바터제휴배너', '협의완료', '인근 요가 스튜디오 교차 배너', 'A2', '이미지',
   '2026-05-01', '2026-05-31', 0, '상호 원데이 체험권 발급', false, '{}', false),
  ((select id from branches where slug = 'hanti'),
   'D-OOH', '전단지', '게시중', '한티역 아침 배포', 'A5', '이미지',
...
values
  ((select id from branches where slug = 'magok'),
   'P-OOH', 'OOH', '협의완료', 'LG사이언스파크 셔틀 내부 광고', null, '이미지',
   '2026-05-01', '2026-05-31', null, null, false, '{}', true),
  ((select id from branches where slug = 'magok'),
   'P-OOH', '현수막', '게시중', '센터 1층 대로변', '가로 4m × 세로 1.2m', '이미지',
   '2026-04-01', '2026-04-30', 160000, null, false, '{}', false),
  ((select id from branches where slug = 'magok'),
   'A-OOH', '바터제휴배너', '게시중', '카페마곡 창측 배너', 'A1', '이미지',
   '2026-04-10', '2026-05-09', 0, '주 1회 라떼 시음권 제공', true, '{}', false),
  ((select id from branches where slug = 'magok'),
   'D-OOH', '족자', '미진행', '10호선 연장 예정 역 인근 후보', null, null,
   null, null, null, null, false, '{}', false);
...
values
  ((select id from branches where slug = 'pangyo-venture'),
   'P-OOH', 'OOH', '미진행', '벤처타운 셔틀버스 외부 래핑 후보', null, null,
   null, null, null, null, false, '{}', true),
  ((select id from branches where slug = 'pangyo-venture'),
   'P-OOH', '현수막', '게시중', '단지 내 공용 게시대', '가로 3m × 세로 1m', '이미지',
   '2026-04-01', '2026-04-30', 110000, null, false, '{}', false),
  ((select id from branches where slug = 'pangyo-venture'),
   'A-OOH', '바터제휴배너', '협의중', '벤처 카페 라운지 배너 교환', 'A2', '이미지',
   null, null, null, '입주 기업 대상 단체 체험권', false, '{}', false),
  ((select id from branches where slug = 'pangyo-venture'),
   'D-OOH', '전단지', '게시중', '입주사 메일룸 비치', 'A5', '이미지',
...
values
  ((select id from branches where slug = 'yeoksam-gfc'),
   'P-OOH', 'OOH', '협의완료', 'GFC 내부 엘리베이터 디지털 사이니지', null, '영상',
   '2026-05-01', '2026-05-31', null, null, false, '{}', true),
  ((select id from branches where slug = 'yeoksam-gfc'),
   'P-OOH', '현수막', '게시종료', '1층 로비 입구 현수막', '가로 3m × 세로 1m', '이미지',
   '2026-03-01', '2026-03-31', 140000, null, false, '{}', false),
  ((select id from branches where slug = 'yeoksam-gfc'),
   'A-OOH', '바터제휴배너', '게시중', '오피스 공용 라운지 배너', 'A1', '이미지',
   '2026-04-05', '2026-05-04', 0, '입주사 제휴 이벤트 운영', true, '{}', false),
  ((select id from branches where slug = 'yeoksam-gfc'),
   'D-OOH', '전단지', '협의중', '빌딩 출입구 배포 일정 협의', 'A5', null,
   null, null, null, null, false, '{}', false);
...
values
  ((select id from branches where slug = 'hapjeong'),
   'P-OOH', 'OOH', '협의중', '합정역 AK& 인근 버스쉘터', null, null,
   null, null, null, null, false, '{}', true),
  ((select id from branches where slug = 'hapjeong'),
   'P-OOH', '현수막', '게시중', '망원로 방향 건물 외벽', '가로 4m × 세로 1m', '이미지',
   '2026-04-01', '2026-04-30', 145000, null, false, '{}', false),
  ((select id from branches where slug = 'hapjeong'),
   'A-OOH', '바터제휴배너', '게시중', '망원시장 상인회 배너', 'A2', '이미지',
   '2026-04-10', '2026-05-09', 0, '상인회 대상 주 1회 클래스 개방', false, '{}', false),
  ((select id from branches where slug = 'hapjeong'),
   'D-OOH', '족자', '아이디어', '합정역 2번 출구 공터 거치 아이디어', null, null,
   null, null, null, null, true, '{}', false);
...
-- 5a) unofficial_update — P-OOH(공식매체) + 게시중 매체 (지점별 1건)
